...
const char *spcmd2[] = {"st",     "-n", "spspot", "-g",
                        "144x41", "-e", "ncspot", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_s, spawn,
     SHCMD("flatpak run com.symless.synergy")},
    {MODKEY | ShiftMask, XK_n, spawn,
     SHCMD("~/.config/nerd-dictation/./process.sh")},
    {MODKEY | ShiftMask, XK_m, spawn,
     SHCMD("~/.config/nerd-dictation/./process.sh 0")},
    {MODKEY | ShiftMask, XK_n, spawn, SHCMD("screenshot")},
